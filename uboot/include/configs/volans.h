...
#define CONFIG_BOOTARGS		"mem=32M console=ttyS0,57600n8 rootfstype=yaffs2 root=/dev/mtdblock2 rw"
#define CONFIG_BOOTCOMMAND	"nboot 0x80600000 0 0x400000; bootm"
#define CFG_AUTOLOAD		"y"		/* Do autoload */
...
#define	CFG_LOAD_ADDR		0x80010000     /* default load address	*/
